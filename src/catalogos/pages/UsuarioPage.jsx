...
//los estilos comunes de los NavLink a una función para evitar repetición:
    ...
    <>
      <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div className="bg-white p-4">
          ...
          <h1 className="flex pb-8 text-5xl font-extrabold text-colorPrimario">Administración de<small className="ml-2 font-semibold text-gray-500">usuarios</small></h1> 
              <nav className="flex" aria-label="Breadcrumb">
                <ol className="inline-flex items-center space-x-1 md:space-x-3">
                  <li className="inline-flex items-center">
                    <NavLink end to="/catalogo/usuario/lista" className={navLinkClass}>
...
//replace evita agregar la redirección al historial del navegador.