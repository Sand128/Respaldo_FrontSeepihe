      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
            ...
            <div className="text-xs text-slate-500 italic">{ profile === 1 ? 'Administrador' : (profile === 2 ? 'Captura' : (profile === 3 ? 'Supervisión' : (profile === 4 ? 'Captura y Supervisión' : 'Otro usuario'))) }</div>
          </div>
          <ul>
            {/* <li>
              <Link
